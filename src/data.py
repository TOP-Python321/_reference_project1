...
COMMANDS = {
    ...
    'вкл/выкл координаты': ('coords', 'c', 'координаты', 'к'),
...
# надстрочные символы цифр
# не во всех шрифтах присутствуют все эти символы — если у вас вместо символов надстрочных цифр отображаются прямоугольники, то скорее всего вам необходимо сменить шрифт (в рекомендуемом мной Hack все используемые символы есть)
superscript_digits: str = '\u2070\u00b9\u00b2\u00b3\u2074\u2075\u2076\u2077\u2078\u2079'
# переключатель надстрочных подсказок
...
# шаблон игрового поля для надстрочных подсказок
field_for_superscripts: str = None

# словарь всех ячеек игрового поля --> номер: ' '
board: dict[int, str] = {}
# словарь всех ячеек игрового поля с надстрочными подсказками, например 9: '  ⁹'
board_with_superscripts: dict[int, str] = {}
...
MESSAGES = {
    ...
    'координаты': ' ! отображение координат {}',
